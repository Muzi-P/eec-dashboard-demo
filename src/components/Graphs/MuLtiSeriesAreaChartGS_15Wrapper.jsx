      ...
      return (
        <InputGroupText className="reveiwYear" key={year}>
          <Input
            ...
            value={year}
            key={year}
            checked={gs15ReviewYears.includes(year)}
          />
          {year}
        </InputGroupText>
      );
      ...
      <Row>
        <Col xs="12">
          <Card className="card-chart">
            <CardHeader>
              <Row>
                <Col className="text-left" sm="6">
                  {gs15ReviewYears.length !== 0 && (
                    <h5 className="card-category">
                      Review Year: {gs15ReviewYears.toString()}
                    </h5>
                  )}
            ...
            <CardBody>
              <MultiSeriesAreaChartGs15
                data={this.context.populateGS15DataPoints()}
